...
ocToggleButton.innerHTML = '<a tabindex="10" class="sky-dropdown__link link link--clickable"><span class="sky-dropdown__label">Stop OcuTweaks</span></a>';
    ...
    init() {
        ...
        helpButton.onclick = function() {
            ...
            if(document.getElementsByClassName('sky-dropdown__item').length > 0) {
                var feedbackButton = document.getElementsByClassName('sky-dropdown__item')[1];
                if (!!feedbackButton) {
                    try {
